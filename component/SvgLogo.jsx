...
const SvgLogo = () => {
    ...
    return (
        <>
            {/* Desktop SVG */}
            <div ref={container} className="hidden md:block" style={{ maxWidth: '1200px', margin: '0 auto' }}>
                <svg
                    width="100%"
                    height="100%"
            ...
            {/* Mobile SVG (bigger) */}
            <div className="block md:hidden" style={{ maxWidth: '100vw', margin: '0 auto' }}>
                <svg
                    width="100%"
                    height="100%"
                    viewBox="0 0 1608 464"
                ...
                >
                    <path d="M5 5V459H333.356V345.5H150.936V118.5H333.356V5H5ZM399.027 5H756.571V118.5H530.37V151.882H720.087V285.412H530.37V345.5H756.571V459H399.027V285.412L442.808 218.647L399.027 185.265V5ZM814.945 5H1172.49V118.5H938.991V252.029L814.945 151.882V5ZM1048.44 218.647V345.5H814.945V459H1172.49V285.412L1048.44 218.647ZM1216.27 5H1603V459H1486.25V345.5L1347.61 218.647H1486.25V118.5H1347.61V459H1216.27V5Z" stroke="white" strokeWidth="10" />
                </svg>
            </div>
        </>
    );
