      ...
      <div className="md:max-w-[85vw] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex text-white space-x-8 items-center">
            <a href="#home" className="navlink text-2xl text-white/80 hover:text-[#CF9EFF] transition-all duration-300 cursor-pointer relative group">
              Home
            ...
            <a href="#about" className="navlink text-2xl text-white/80 hover:text-[#CF9EFF] transition-all duration-300 cursor-pointer relative group">
              About Us
              <div className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-[#CF9EFF] to-[#A855F7] group-hover:w-full transition-all duration-300"></div>
            </a>
            <a href="#events" className="navlink text-2xl text-white/80 hover:text-[#CF9EFF] transition-all duration-300 cursor-pointer relative group">
              Events
              <div className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-[#CF9EFF] to-[#A855F7] group-hover:w-full transition-all duration-300"></div>
            </a>
